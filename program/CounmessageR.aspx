<%@ Page Title="" Language="C#" MasterPageFile="~/program/Hcounter.master" AutoEventWireup="true" CodeFile="CounmessageR.aspx.cs" Inherits="program_CounmessageR" %>
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="cid" 
                            DataNavigateUrlFormatString="CounmessageR1.aspx?{0}" DataTextField="subject" 
                            HeaderText="Subject" />
                    </Columns>
