<%@ Page Title="" Language="C#" MasterPageFile="~/program/Hadmin.master" AutoEventWireup="true" CodeFile="AdmessageR.aspx.cs" Inherits="program_Admessage" %>
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="cid" 
                            DataNavigateUrlFormatString="AdmessageR1.aspx?{0}" DataTextField="subject" 
                            HeaderText="Subject" />
                    </Columns>
