<%@ Page Title="" Language="C#" MasterPageFile="~/program/Hdoctor.master" AutoEventWireup="true" CodeFile="DomassageR.aspx.cs" Inherits="program_DomassageR" %>
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="cid" 
                            DataNavigateUrlFormatString="DomassageR1.aspx?{0}" DataTextField="subject" 
                            HeaderText="Subject" />
                    </Columns>
