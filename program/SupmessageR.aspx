<%@ Page Title="" Language="C#" MasterPageFile="~/program/Hsuperant.master" AutoEventWireup="true" CodeFile="SupmessageR.aspx.cs" Inherits="program_SupmessageR" %>
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="cid" 
                            DataNavigateUrlFormatString="SupmessageR1.aspx?{0}" DataTextField="subject" 
                            HeaderText="Subject" />
                    </Columns>
