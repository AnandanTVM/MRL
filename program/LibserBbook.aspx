<%@ Page Title="" Language="C#" MasterPageFile="~/program/Hlibrarian.master" AutoEventWireup="true" CodeFile="LibserBbook.aspx.cs" Inherits="program_LibserBbook" %>
            ...
            <td colspan="2">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="bid" DataTextField="dob" 
                            HeaderText="DOB" DataNavigateUrlFormatString="LibserBbook1.aspx?{0}" />
                    </Columns>
