<%@ Page Title="" Language="C#" MasterPageFile="~/program/Hsuperant.master" AutoEventWireup="true" CodeFile="SupsreCasesheet.aspx.cs" Inherits="program_SupsreCasesheet" %>
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="caid" DataTextField="currentstatus" 
                            ...
                            DataNavigateUrlFormatString="SupserCasesheet1.aspx?{0}" />
                    </Columns>
